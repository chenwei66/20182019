...
@TeleOp(name="RoboDriveNew_MS", group="11697")
// @Disabled

public class RoboDriveNew extends LinearOpMode {
...
//        );
        ...
        while (opModeIsActive()) {
            ...
            else if (gamepad1.b ) {  // pull back the long arm
            ...
            //Set Right Trigger Flag
            if(gamepad1.right_trigger > 0){
                RightTrigger = true;
            }

            if(RightTrigger == true){
                if(robot.longMotor.getCurrentPosition() > 10){
                    robot.longMotor.setPower(-0.9);
                }
                else {
                    robot.longMotor.setPower(0);
            ...
            if ((gamepad1.left_trigger > 0) && RightTrigger == false) {
