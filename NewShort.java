...
@Autonomous(name="NewShort", group ="11697")
//BLUE Left has "public class BlueLeft extends LinearOpMode
public class NewShort extends LinearOpMode {
        ...
        if(tfod != null) {
           ...
           while (opModeIsActive()) {
               ...
               telemetry.update();
                ...
                robot.boostedMotor.setTargetPosition(9390);
