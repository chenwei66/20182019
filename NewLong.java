...
@Autonomous(name="NewLong", group ="11697")
//BLUE Left has "public class BlueLeft extends LinearOpMode
public class NewLong extends LinearOpMode {
...
//               driveByEncoder(0.5,0.5,0.5);
            ...
            switch(GoldPosition) {
                ...
                case "RIGHT":
                    ...
                    driveByEncoder(0.5, 0.0,  5.0);
                    driveByEncoder(0.5, 5.0,  0.0);
                    driveByEncoder(0.5, 20.0,  20.0);
                    driveByEncoder(0.5, 3.6,-3.6);
                    driveByEncoder(0.5, 0.0,  6.0);
                    driveByEncoder(0.5, 1.5,  0.0);
                    driveByEncoder(0.5, 16.0,  16.0);
